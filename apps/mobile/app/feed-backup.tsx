...
import MessagesFloatingMenu from '../components/MessagesFloatingMenu';
...
export default function FeedScreen() {
  ...
  return (
    <View style={[styles.safeArea, { backgroundColor: colors.backgroundLight }]}>
      ...
      {/* Messages Floating Menu - only show when on messages tab */}
      {activeTab === 'messages' && (
        <MessagesFloatingMenu onNewMessage={() => setShowNewMessageModal(true)} />
      )}
    </View>
  );
}
