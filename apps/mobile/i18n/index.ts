...
const translations: Record<string, string> = {
  ...
  'settings.groqApiKey': 'Google Gemini API Key',
  'settings.geminiApiKey': 'Google Gemini API Key',
  'settings.groqApiKeyPlaceholder': 'Indtast din Google Gemini API key...',
  'settings.geminiApiKeyPlaceholder': 'Indtast din Google Gemini API key...',
