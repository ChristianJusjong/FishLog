...
export type ContestRule = 'biggestSingle' | 'biggestTotal' | 'mostCatches' | 'longestFish' | 'mostSpecies' | 'biggestAverage';
/**
 * Fish species constants
 */
export declare const FISH_SPECIES: readonly ["pike", "perch", "zander", "trout", "carp", "bream", "roach", "tench", "eel", "cod", "mackerel", "seaTrout", "flounder", "seaBass", "pollock", "herring", "garfish"];
